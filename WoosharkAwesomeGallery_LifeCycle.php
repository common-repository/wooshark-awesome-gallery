...
include_once('WoosharkAwesomeGallery_InstallIndicator.php');

class WoosharkAwesomeGallery_LifeCycle extends WoosharkAwesomeGallery_InstallIndicator {
    ...
    protected function addSettingsSubMenuPageToPluginsMenu() {
        ...
        add_menu_page(
            ...
            plugin_dir_url(__FILE__) . 'images/wish-icon_27x27.png');
}
